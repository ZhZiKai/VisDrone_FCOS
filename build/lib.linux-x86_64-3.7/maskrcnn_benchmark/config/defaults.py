...
# for <class 'maskrcnn_benchmark.data.transforms.transforms.RandomSampleCrop'>
_C.INPUT.CROP_SIZE = 1024
_C.INPUT.RANDOM_CROP_FIXED = False
...
# P2 for backbone
_C.MODEL.BACKBONE.USE_P2 = False
...
_C.MODEL.RESNETS.USE_DCN = False
...
_C.MODEL.FCOS.FPN_STRIDES_ADDP2 = [8, 16, 32, 64, 128, 256]
...
# multi scale test
_C.TEST.MS_TEST = False

_C.TEST.MS_TEST_NMS = "nms"

_C.TEST.MS_TEST_NMS_THR = 0.7

_C.TEST.MIN_SIZE_RANGE_TEST = (1000, 1300, 1500)
